...
const Home: React.FC<HomeProps> = ({
  ...
  return (
    <Element name="Home" className="max-w-3xl pb-20 mx-auto font-robo border border-white/30 shadow-sm shadow-white/50 h-fit mt-18 rounded-xl backdrop-blur-sm">
        ...
        `}>
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-16">
            ...
            <div className="relative group flex-shrink-0">
              <div className="absolute -inset-4 rounded-full opacity-75 group-hover:opacity-100 blur-lg group-hover:blur-xl transition-all duration-500 animate-pulse bg-gradient-to-r from-white via-gray-300 to-white"></div>
              <div className="absolute -inset-2 rounded-full opacity-50 group-hover:opacity-75 blur transition-all duration-300 bg-gradient-to-r from-gray-200 to-white"></div>

              <div className="relative">
                <div className="w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-4 backdrop-blur-sm shadow-2xl transform group-hover:scale-105 transition-all duration-500 ease-out border-white/20 shadow-white/10">
                  <img
                    src={src}
                    alt="Profile Image"
            ...
            `}>
              ...
              <div className={`
                mt-8 lg:mt-10 flex flex-col sm:flex-row lg:justify-start sm:justify-center gap-4 sm:gap-6
                transform transition-all duration-1000 ease-out
