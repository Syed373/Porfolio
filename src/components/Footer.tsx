    ...
    <div className='w-full max-w-3xl pb-4  mx-auto border border-white/30 shadow-sm shadow-white/50 my-2 rounded-xl backdrop-blur-sm px-4 sm:px-6 lg:px-8 font-robo text-background sm:flex items-center justify-center'>
      <div className='sm:w-1/2'>
        ...
        <div className='space-x-8 flex flex-col justify-center items-start px-4'>
          <a href="/" className='text-background/50 hover:text-background transition-all duration-300 ease-in-out'>Home</a>
          <a href="/" className='text-background/50 hover:text-background transition-all duration-300 ease-in-out'>About</a>
          <a href="/" className='text-background/50 hover:text-background transition-all duration-300 ease-in-out'>Projects</a>
          <a href="/" className='text-background/50 hover:text-background transition-all duration-300 ease-in-out'>Contact</a>
        </div>
      </div>
        ...
        <div className='text-center text-sm text-background/50 space-y-4 mx-4 mt-6'>
          ...
          <h1>Built with Next.js, Tailwind, and shadcn/ui</h1>
        </div>
    </div>
  )
}
